 ...
 const stickyStyle = navSticky ? "md:hidden hidden md:flex flex-row shadow-gray-100 shadow-sm":""
  ...
  return (
    ...
    <header className="text-gray-400  bg-gray-900 body-font">
      <div className="container mx-auto ${stickyStyle}  flex flex-wrap p-5 flex-col md:flex-row items-center">
        <a className="flex title-font font-medium items-center text-white mb-4 md:mb-0">
          ...
          />
          <span className="ml-3 text-xl font-serif font-medium">Hafsa Kamali</span>
        </a>
  ...
  <li> <Link href="/" className="mr-5 text-white border border-white rounded-full px-4 hover:scale-110"> Home </Link></li>
  <li className="group relative z-50">
  <Link href="/" className="mr-5 text-white border border-white rounded-full px-4 hover:scale-110">Blogs</Link>
  ...
  <li> <Link href="/about" className="mr-5 text-white border border-white rounded-full px-4 hover:scale-110">About</Link></li>
  <li> <Link href="/contact" className="mr-5 text-white border border-white rounded-full px-4 hover:scale-110">Contact</Link></li>
  </ul>
  </nav>

<button className="inline-block items-centers hidden md:flex flex-row gap-4 bg-gradient-to-r from-slate-500 to-gray-700 border border-white py-2 px-3 focus:outline-none hover:from-slate-500 to-gray-500 hover:scale-110  text-white rounded-md text-base mt-4 md:mt-0">
  Log In
</button>
<button className="relative inline-block ml-[1rem] hidden md:flex flex-row gap-4 px-3 py-2 bg-gradient-to-r from-slate-500 to-gray-700 border border-white text-white rounded-xl overflow-hidden transition-all duration-500 before:absolute before:top-0 before:left-[-100%] before:w-full before:h-full before:bg-[#f2f2f2] before:transition-all before:duration-500 hover:before:left-0 hover:text-[#1a1a1a]">
